...
Write-Host "Setting thread scheduling policy to: All processors (0)" -ForegroundColor Green
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "Successfully set policy to: All processors" -ForegroundColor Green
} else {
